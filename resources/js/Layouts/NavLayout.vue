        ...
        <div class="dropdown-menu menu-drop-user">
          <div class="profilename">
            <div class="profileset">
              <span class="user-img"
                ><img src="/Assets/img/avator1.jpg" alt="" />
            ...
            <Link
              :href="route('logout')"
              method="post"
              class="text-decoration-none dropdown-item logout pb-0"
            >
              <img
