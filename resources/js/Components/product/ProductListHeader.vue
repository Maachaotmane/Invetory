<template>
    <div class="page-header">
        ...
        <div class="page-btn">
            <router-link to="/inventory/add-product" class="project-btn"><vue-feather type="plus-circle"
                    class="me-2"></vue-feather>Add New
                Product</router-link>
        </div>
        <div class="page-btn import">
            <a href="javascript:void(0);" class="btn btn-added color" data-bs-toggle="modal"
                data-bs-target="#view-notes"><vue-feather type="download" class="me-2"></vue-feather>Import Product</a>
        </div>
    </div>
</template>
<script>
